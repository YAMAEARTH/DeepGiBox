use anyhow::Result;
use common_io::{DType, MemLoc, MemRef, RawFramePacket, Stage, TensorDesc, TensorInputPacket};
...
pub fn from_path(_cfg: &str) -> Result<PreprocessStage> {
    Ok(PreprocessStage {})
}
