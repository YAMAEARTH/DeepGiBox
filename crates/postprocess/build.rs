// Build script for GPU-accelerated postprocessing
...
fn main() {
    ...
    println!("cargo:rerun-if-changed=nms_gpu.cu");
    ...
    build.compile("nms_gpu");
    
    // Link CUDA runtime
    println!("cargo:rustc-link-search=native={}/lib64", cuda_path);
    println!("cargo:rustc-link-lib=cudart");
    
    println!("cargo:warning=GPU postprocessing CUDA kernel compiled successfully!");
}
